    ...
    <>
      ...
      <main>
          ...
          <div className="container">
            <div className="row mx-5 py-5 ">
              <div className="col-md-6 ">
                ...
                <span className='ms-5 '>
                  <BsPlayCircle /> Watch the demo</span>
              </div>
              <div className="col-md-6">
                <Image className='img' src={img} width={450} height={300} alt={img} />
              </div>
            </div>
          </div>
          <div className="container-fluid logos">
            <div className="row row-logo">
              <div className="col-md-12 ">
                <Image className='' src={img2} width={180} height={130} alt={img2} />
        ...
        <section className='style py-5'>
          ...
          <p className=' py-3 style-p py-2 '>Doloremque landantium,totam rem aperiam,eaque ipsa quae ab illo inventor veritatis et quasi architecto beatae vitae dicta sunt explicabo</p>
          <div className="container">
            <div class="row">
              <div class="col-sm-4 mb-3 mb-sm-0">
                <div class="card">
                  <div class="card-body">
                    <button className='text-primary my-4 ms-3 btn-stlyle'><BiBrain /></button>
              ...
              <div class="col-sm-4">
                <div class="card">
                  <div class="card-body">
                    <button className='text-primary my-4 ms-3 btn-stlyle'><BsGraphUpArrow /></button>
              ...
              <div class="col-sm-4">
                <div class="card">
                  <div class="card-body">
                    <button className='text-primary my-4 ms-3 btn-stlyle'><FaKey /></button>
        ...
        <section>
          <div className="container">
            <div className="row mx-5 py-5 ">
              ...
              <div className="col-md-6">
                <Image className='img' src={img8} width={450} height={300} alt={img8} />
              </div>
            </div>
          </div>
          <div className="container">
            <div className="row mx-5 py-5">
              <div className="col-md-6">
                <Image className='img' src={img9} width={450} height={300} alt={img9} />
              </div>
              <div className="col-md-6 ">
                <h2 className='fs-1 '>Find true power in your data with Ensome</h2>
                <p>set ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,totam rem aperiam,eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
            ...
            <div class="row">
              <div class="col-sm-4 mb-3 mb-sm-0">
                <div class="card">
                  <div class="card-body">
                    <p>22 June 2020</p>
                    <h3 class="card-title">Set ut perspiciatis unde omnis at vero blanditils</h3>
                    <p class="card-text">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prasentium voluptatum deleniti...</p>
                    <div>
                      <button className='bg-white mx-1 text-primary  style-btn'>Proxy</button>
                      <button className=' bg-white mx-1 text-primary  style-btn'>Vpn </button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section>
          <h2 className='py-5 style-section'>Trusted by the best in the business </h2>

          <div className="container">
            <div class="row row-cols-1 row-cols-md-2 g-4">
              <div class="col-md-6 ">
                <div class="card position-relative shadow-sm ">
                  <Image className='position-absolute top-0 start-0 translate-middle ms-5' src={img11} width={75} height={75} alt={img11} />
              ...
              <div class="col-md-6 ">
                ...
                <div class="card  position-relative shadow-sm">
                  <Image className='position-absolute top-0 start-0 translate-middle ms-5' src={img10} width={75} height={75} alt={img10} />
                  <p class="card-text mx-4 mt-5">``Ut enim ad minima veniam ,quis nostrum exercitationem ullam corporis suscipit laboriosam,nisi ut aliquid ex ea commodi consequatur?Quisi autem vel eum iure reprehenderit qui in ea voluplate velit esse quam nihil molestiae consequatur,vel illum. ``</p>
                  <h5 className="card-title mx-4"> Alex Bern</h5>
